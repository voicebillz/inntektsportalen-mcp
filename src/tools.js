// =====================================================================
// Verktøy-katalog for Inntektsportalen MCP — ÉN kilde til sannhet.
//
// `registerTools(server, api)` registrerer alle verktøyene på en McpServer.
// Brukes IDENTISK av både den lokale (stdio) og den eksterne (HTTP) serveren,
// slik at regel-/tilgangsstrukturen er nøyaktig den samme uansett transport.
//
// Backend håndhever til slutt all tilgang (default-deny + scopes); MCP-en kan
// aldri gjøre noe brukeren ikke selv kan, og aldri 2FA/sikkerhet, budsjett
// åpne/lukke, eller bruke Assistenten/Simuler.
// =====================================================================
import { z } from 'zod'
